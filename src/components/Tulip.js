...
import SVGPATH from 'svg.path.js'; // eslint-disable-line no-unused-vars
...
export const genesToString = (genes) => {
  let s = '';
  genes.forEach((g) => {
...
class Tulip extends React.Component {
  ...
  drawTulip(ref) {
    ...
    this.drawLine(draw, genes);
    const cur = this.drawShape(draw, 'back', genes);
